...
presets_to_dbs(PresetNames) ->
    ...
    Presets0 = proplists:get_value(presets, Config, []),
    Presets1 = proplists:get_value(toml, Presets0, []),
    Presets2 = lists:filter(fun({Name,_}) -> lists:member(Name, PresetNames) end, Presets1),
