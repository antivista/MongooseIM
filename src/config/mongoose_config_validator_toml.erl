...
-spec validate(mongoose_config_parser_toml:option_value(),
               mongoose_config_parser_toml:option_type(),
               option_validator()) -> any().
...
-spec validate_list([mongoose_config_parser_toml:option()], list_validator()) -> any().
...
-spec validate_section([mongoose_config_parser_toml:option()], section_validator()) -> any().
